...
export class Home extends Component {
  ...
  render () {
    return (
      <div>
        <h1 className="center-elem">Welcome to the awesome Online-Multiplayer-Lama!</h1>
        ...
        <p>You can play any card with the same number as the top card, or one higher. Cards range from 1 to 6. The LAMA card closes the loop: It can be played on top of a 6 and is succeeded by a 1.</p>
        ...
        <p>Each type of card in a players hand is counted as minus points according to the cards value. A LAMA is worth 10 minus points.</p>
